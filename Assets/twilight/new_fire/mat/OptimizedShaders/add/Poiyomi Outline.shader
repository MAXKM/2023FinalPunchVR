Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Outline/f2146e81a12553a49901d4800540272d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				float shadowStrength = (0.55 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
				...
				if ((1.0 /*_LightingMulitlayerNonLinear*/))
				{
					...
					lns.w = poiEdgeNonLinearNoSaturate(poiLight.lightMap, (0.5 /*_ShadowBorder*/), (0.1 /*_ShadowBlur*/) * blurMap.r, (0.255 /*_ShadowBorderRange*/));
				}
				else
				{
					...
					lns.w = poiEdgeLinearNoSaturate(poiLight.lightMap, (0.5 /*_ShadowBorder*/), (0.1 /*_ShadowBlur*/) * blurMap.r, (0.255 /*_ShadowBorderRange*/));
				}
				lns = saturate(lns);
				...
				if (float4(0.3229691,0.3229691,0.3229691,1).a > 0)
				{
					#if defined(PROP_SHADOW2NDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow2ndColorTex.rgb = lerp(float3(1, 1, 1), shadow2ndColorTex.rgb, shadow2ndColorTex.a) * float4(0.3229691,0.3229691,0.3229691,1).rgb;
					lns.y = float4(0.3229691,0.3229691,0.3229691,1).a - lns.y * float4(0.3229691,0.3229691,0.3229691,1).a;
					indirectColor = lerp(indirectColor, shadow2ndColorTex.rgb, lns.y);
				}
				if (float4(0.3119799,0.3119799,0.3119799,1).a > 0)
				{
					#if defined(PROP_SHADOW3RDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow3rdColorTex.rgb = lerp(float3(1, 1, 1), shadow3rdColorTex.rgb, shadow3rdColorTex.a) * float4(0.3119799,0.3119799,0.3119799,1).rgb;
					lns.z = float4(0.3119799,0.3119799,0.3119799,1).a - lns.z * float4(0.3119799,0.3119799,0.3119799,1).a;
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.6396053,0.6396053,0.6396053,0.08627451).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.6396053,0.6396053,0.6396053,0.08627451).a;
