Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/61cdad4a27f628544bd260e6999f046f"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#ifdef UNITY_PASS_FORWARDBASE
				poiFragData.emission = max(poiFragData.emission * (0.0 /*_PPEmissionMultiplier*/), 0);
